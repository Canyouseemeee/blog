        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"> Tracker
                    <a href="/dynamic-create" class="btn btn-primary float-right">Add</a>
                    <a href="/dynamic-index" class="btn btn-primary float-right">index</a>
                </h4>
            </div>
            <div class="card-body">
                ...
                <div class="form-group">
                    <input type="text" class="tracker_id" id="tracker_id" name="tracker_id" hidden="hidden">
                </div>
                {{ csrf_field() }}
            </div>
        </div>
